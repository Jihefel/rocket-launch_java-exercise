public class Rocket {
    ...
    // Space X Falcon 9
    static private double THRUST = 8127000; // N
    // Carburant
    ...
    private static double calculateAcceleration(double thrust, double mass) {
        return (thrust - (mass * 9.81/* gravité terrestre */)) / mass;
    }
    ...
    public static void launch() {
        ...
        while (altitude < ORBIT_ALTITUDE) {
            ...
            System.out.println("Acceleration actuelle : " + acceleration + " m/s2");
